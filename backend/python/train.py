...
def train_and_save(n_per_class: int = 60, frames: int = 14, seed: int = 20260911) -> Dict:
    X, y, meta = build_corpus(n_per_class=n_per_class, frames=frames, seed=seed)
    ...
    if use_mlp:
        ...
        model = {
            "version": "ctxtrace-ai-model v3 (mlp-16-32-16-1)",
            "architecture": "mlp",
